...
ActiveRecord::Schema.define(version: 20170403070750) do
  ...
  create_table "customers", force: :cascade do |t|
    ...
    t.string   "cust_phone"
    t.string   "cust_other_phone"
    t.datetime "created_at",       null: false
    t.datetime "updated_at",       null: false
    t.integer  "owner_id"
    t.integer  "shop_id"
    t.index ["owner_id"], name: "index_customers_on_owner_id", using: :btree
